...
//	
//	public List<NoticeDTO> cs_notice_sel(String search){
//		map = new HashMap<String, Object>();
//		map.put("search", search);
//		List<NoticeDTO> notice_list = session.selectList("sql.cs_notice_select",map);
//		return notice_list;
//	}
//	public Integer cs_count() {
//		return session.selectOne("sql.cs_notice_count");
//	}
//	public List<NoticeDTO> cs_notice_sel2(String pgno, int total, String cate, String search,String check){
//		int pageview =10;
...
//		this.pg.add(total);
//		this.pg.add(cate);
//		List<NoticeDTO> notice_list2 = null;
//		map = new HashMap<String, Object>();
